...
| `redirectMode`            | `fallback`  | `fallback`, `fullPage` - An optional configuration to change how redirects to payment providers are performed. `fallback` will attempt a popup before redirecting, `fullPage` will always redirect. This can be useful for testing purposes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
