...
describe('setupFrame()', () => {
  test('should initialize and bind a new frame', () => {
    ...
    expect(element.innerHTML).toContain(
      '<iframe src="http://127.0.0.1:8080/" title="Secure payment frame - Gr4vy" style="visibility: hidden; width: 100%; height: 0px; border: 0px; overflow: hidden;" frameborder="0" scrolling="no"></iframe>'
    )
  })
})
...
describe('initFrame()', () => {
  test('should initialize a new iframe', () => {
    ...
    expect(frame.getAttribute('style')).toEqual(
      'visibility: hidden; width: 100%; height: 0px; border: 0px; overflow: hidden;'
    )
