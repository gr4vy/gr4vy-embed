...
| `redirectMode`            | `fallback`   | `fallback`, `fullpage` - An optional configuration to change how redirects to payment providers are performed. Auto will attempt a popup before redirecting, `redirect` will always redirect. This can be useful for testing purposes.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
