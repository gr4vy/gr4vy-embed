...
| `approvalExpiresAt` | `string \| null` | An optional datetime string (ISO 8601 format recommended) that sets the expiration date for transaction approval. If set to `null`, it is treated the same as if it were omitted. |
