...
| `compactPaymentOptions`   | `false`      | An optional boolean to render payment options in a compact variant with shorter row height, tighter accordion padding, and no divider between the option header and its expanded content.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
