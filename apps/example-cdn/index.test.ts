...
test('embed is able to load on the page', async ({ page }) => {
  ...
  await expect(await iframe.innerText()).toBe(
    '{"amount":1299,"currency":"USD","apiHost":"api.demo.gr4vy.app","gr4vyId":"demo","token":"123456","store":"ask","country":"US","display":"all","apiUrl":"https://api.demo.gr4vy.app","requireSecurityCode":false,"showDeleteButton":false,"enableAnimations":false,"separatePaymentOptions":false,"supportedApplePayVersion":0,"supportedGooglePayVersion":1,"hasBeforeTransaction":false}'
  )
